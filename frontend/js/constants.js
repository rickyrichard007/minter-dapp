const contractAddress = "0xCC3A6DfE39f1644bDfE4A484F52C244FbC4A5Aee"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to the Pixel Pac Man NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The Pixel Pac Man NFT Project is a decentralized open-source project.';
